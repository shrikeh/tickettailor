 ...
 */
class Api_Console_KernelDevDebugContainer extends Container
{
    protected $targetDir;
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['Api\\Console\\Kernel']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Api_Console_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'App' => [
                    'path' => (\dirname(__DIR__, 5).'/vendor/shrikeh/app-symfony/src'),
                    'namespace' => 'Shrikeh\\App\\Bundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'Api_Console_KernelDevDebugContainer',
